...
<body>
	...
	<form name="form1" action="user/save.htm" method="post" class="form-horizontal" role="form">
		...
		<table class="table">
			...
			<tr>
				<td>登陆名</td>
				<td>
						<input class="form-control" type="text" name="username" value="${model.username}" required='required' />
				</td>
			</tr>
					<tr>
				<td>真实姓名</td>
